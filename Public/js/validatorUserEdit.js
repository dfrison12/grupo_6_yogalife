window.addEventListener("load", () => {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (password.value.length == 0){
            errorsPassword.push("Debes ingresar contraseña para Editar Datos")
        } else if (espacios) {
        ...
        let errors = [errorsFullName,errorsDni,errorsAddress,errorsEmail,errorsPassword,errorsImage];
